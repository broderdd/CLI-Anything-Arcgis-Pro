            ...
            try
            {
                ...
                switch (command)
                {
                    ...
                    case "repoint_datasource":
                        ...
                        break;
                    case "save_project":
                        // Project.SaveAsync must run on the application UI thread; DoSaveProject
                        // marshals it onto System.Windows.Application.Current.Dispatcher internally
                        // and returns the Task we await here.
